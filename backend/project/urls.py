...
urlpatterns = [
    ...
    path("s/<slug:code>", SonaLaunchView.as_view(), name="sona-launch"),
    ...
    path("api/v1/auth/profile", AuthProfileView.as_view(), name="auth-profile"),
    ...
    path("api/v1/credits/public", CreditsPublicView.as_view(), name="credits-public"),
    path("api/v1/courses", CourseSectionsView.as_view(), name="courses"),
    path("api/v1/courses/enroll", CourseEnrollView.as_view(), name="courses-enroll"),
    path(
        "api/v1/courses/<int:course_id>/enrollment-code",
        CourseEnrollmentCodeView.as_view(),
        name="courses-enrollment-code",
    ),
    path("api/v1/courses/<int:course_id>/roster", CourseRosterView.as_view(), name="courses-roster"),
    ...
    path("api/v1/admin/users/<int:user_id>/profile", AdminUserProfileView.as_view(), name="admin-user-profile"),
    ...
    path("api/v1/results/checkpoint", SaveCheckpointView.as_view(), name="results-checkpoint"),
